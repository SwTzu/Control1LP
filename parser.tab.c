...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_RUTA = 14,                      /* RUTA  */
  YYSYMBOL_IDENTIFICADOR = 15,             /* IDENTIFICADOR  */
  YYSYMBOL_NUMERO = 16,                    /* NUMERO  */
  YYSYMBOL_REABASTECIBLE = 17,             /* REABASTECIBLE  */
  YYSYMBOL_SUB_GALAXIA = 18,               /* SUB_GALAXIA  */
  YYSYMBOL_GUIADO = 19,                    /* GUIADO  */
  YYSYMBOL_REABASTECER = 20,               /* REABASTECER  */
  YYSYMBOL_LISTAR_VECINOS = 21,            /* LISTAR_VECINOS  */
  YYSYMBOL_MOVER_A = 22,                   /* MOVER_A  */
  YYSYMBOL_23_ = 23,                       /* ';'  */
  YYSYMBOL_YYACCEPT = 24,                  /* $accept  */
  YYSYMBOL_inicio = 25,                    /* inicio  */
  YYSYMBOL_instrucciones = 26,             /* instrucciones  */
  YYSYMBOL_instruccion = 27,               /* instruccion  */
  YYSYMBOL_numero_opcional = 28,           /* numero_opcional  */
  YYSYMBOL_modo_viaje_opcional = 29,       /* modo_viaje_opcional  */
  YYSYMBOL_modo_viaje = 30,                /* modo_viaje  */
  YYSYMBOL_opciones = 31,                  /* opciones  */
  YYSYMBOL_opciones_opcionales = 32,       /* opciones_opcionales  */
  YYSYMBOL_opcion = 33,                    /* opcion  */
  YYSYMBOL_lista_galaxias = 34             /* lista_galaxias  */
};
...
{
       0,   115,   115,   119,   120,   124,   127,   130,   133,   143,
     146,   149,   152,   155,   158,   164,   165,   169,   170,   174,
     175,   179,   180,   184,   185,   192,   193,   197,   198
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MODO_VIAJE", "MENOR_COMBUSTIBLE", "MENOR_GALAXIAS", "RUTA",
  "IDENTIFICADOR", "NUMERO", "REABASTECIBLE", "SUB_GALAXIA", "GUIADO",
  "REABASTECER", "LISTAR_VECINOS", "MOVER_A", "';'", "$accept", "inicio",
  "instrucciones", "instruccion", "numero_opcional", "modo_viaje_opcional",
  "modo_viaje", "opciones", "opciones_opcionales", "opcion",
  "lista_galaxias", YY_NULLPTR
};
...
{
      -3,   -10,    -1,     0,     6,     5,     7,     9,     2,    10,
      12,    21,    -3,   -12,    -9,    13,    14,    15,    11,   -12,
      19,   -12,   -11,   -12,    16,    17,   -12,   -12,   -12,   -12,
      18,    -9,   -12,    20,    22,    24,   -12,    -2,    23,   -12,
     -12,   -12,   -12,   -12,   -12,    25,    26,    27,   -12,   -12,
     -12,   -12,   -12,   -12,    28,   -12
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,     2,     4,    21,     0,     0,     0,     0,    15,
      18,    27,     0,    11,     0,     0,     1,     3,    25,    26,
       0,    22,    23,     0,     0,     0,     9,     0,     0,    28,
      12,    13,    14,     5,    24,     0,     0,     0,    19,    20,
      17,    10,     6,     7,     0,     8
};
...
{
       1,     2,     3,     4,    39,    14,     5,     6,    28,    29,
      48,    49,    40,    17,    15,    16,     7,     8,     9,    10,
      18,    26,     0,    19,    21,    23,    24,    25,    33,    34,
      37,    35,    47,     0,    36,    44,    45,     0,    46,    41,
      42,    43,    54,    27,     0,     0,    51,     0,    52,    53,
       0,    55
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,    15,    15,     9,    10,    17,    18,
      12,    13,    23,     7,    15,    15,    19,    20,    21,    22,
      15,     0,    -1,    16,    15,    23,    16,    15,    15,    15,
      11,    16,     8,    -1,    23,    31,    16,    -1,    16,    23,
      23,    23,    15,    12,    -1,    -1,    23,    -1,    23,    23,
      -1,    23
};
...
{
       0,     3,     4,     5,     6,     9,    10,    19,    20,    21,
      22,    25,    26,    27,    15,    15,    15,     7,    15,    16,
      28,    15,    34,    23,    16,    15,     0,    27,    17,    18,
      31,    32,    33,    15,    15,    16,    23,    11,    29,    15,
      23,    23,    23,    23,    33,    16,    16,     8,    12,    13,
      30,    23,    23,    23,    15,    23
};
...
#line 1245 "parser.tab.c"
  ...
  case 11: /* instruccion: REABASTECER ';'  */
#line 149 "parser.y"
                     {
        reabastecer();
    }
#line 1253 "parser.tab.c"
  ...
  case 12: /* instruccion: GUIADO lista_galaxias ';'  */
#line 152 "parser.y"
                               {
        ejecutar_viaje_guiado((yyvsp[-1].ruta));
    }
#line 1261 "parser.tab.c"
    break;

  case 13: /* instruccion: LISTAR_VECINOS NUMERO ';'  */
#line 155 "parser.y"
                                {
        listar_vecinos((yyvsp[-1].num));
    }
#line 1269 "parser.tab.c"
    break;

  case 14: /* instruccion: MOVER_A IDENTIFICADOR ';'  */
#line 158 "parser.y"
                               {
        mover((yyvsp[-1].str));
    }
#line 1277 "parser.tab.c"
  ...
  case 15: /* numero_opcional: NUMERO  */
#line 164 "parser.y"
           { (yyval.num) = (yyvsp[0].num); }
#line 1283 "parser.tab.c"
    break;

  case 16: /* numero_opcional: %empty  */
#line 165 "parser.y"
                   { (yyval.num) = -1; }
#line 1289 "parser.tab.c"
    break;

  case 17: /* modo_viaje_opcional: MODO_VIAJE modo_viaje  */
#line 169 "parser.y"
                          { (yyval.num) = (yyvsp[0].num); }
#line 1295 "parser.tab.c"
    break;

  case 18: /* modo_viaje_opcional: %empty  */
#line 170 "parser.y"
                   { (yyval.num) = 1; }
#line 1301 "parser.tab.c"
    break;

  case 19: /* modo_viaje: MENOR_COMBUSTIBLE  */
#line 174 "parser.y"
                      { (yyval.num) = 1; }
#line 1307 "parser.tab.c"
    break;

  case 20: /* modo_viaje: MENOR_GALAXIAS  */
#line 175 "parser.y"
                      { (yyval.num) = 2; }
#line 1313 "parser.tab.c"
    break;

  case 21: /* opciones: %empty  */
#line 179 "parser.y"
                 { (yyval.opciones).reabastece = 0; (yyval.opciones).sub_galaxia = 0; }
#line 1319 "parser.tab.c"
    break;

  case 22: /* opciones: opciones_opcionales  */
#line 180 "parser.y"
                          { (yyval.opciones).reabastece = (yyvsp[0].opciones).reabastece; (yyval.opciones).sub_galaxia = (yyvsp[0].opciones).sub_galaxia; }
#line 1325 "parser.tab.c"
    break;

  case 23: /* opciones_opcionales: opcion  */
#line 184 "parser.y"
           { (yyval.opciones).reabastece = (yyvsp[0].opciones).reabastece; (yyval.opciones).sub_galaxia = (yyvsp[0].opciones).sub_galaxia; }
#line 1331 "parser.tab.c"
    break;

  case 24: /* opciones_opcionales: opciones_opcionales opcion  */
#line 185 "parser.y"
                                 {
        (yyval.opciones).reabastece = (yyvsp[-1].opciones).reabastece | (yyvsp[0].opciones).reabastece;
        (yyval.opciones).sub_galaxia = (yyvsp[-1].opciones).sub_galaxia | (yyvsp[0].opciones).sub_galaxia;
    }
#line 1340 "parser.tab.c"
    break;

  case 25: /* opcion: REABASTECIBLE  */
#line 192 "parser.y"
                  { (yyval.opciones).reabastece = 1; (yyval.opciones).sub_galaxia = 0; }
#line 1346 "parser.tab.c"
    break;

  case 26: /* opcion: SUB_GALAXIA  */
#line 193 "parser.y"
                   { (yyval.opciones).reabastece = 0; (yyval.opciones).sub_galaxia = 1; }
#line 1352 "parser.tab.c"
    break;

  case 27: /* lista_galaxias: IDENTIFICADOR  */
#line 197 "parser.y"
                  { (yyval.ruta) = crear_ruta((yyvsp[0].str)); }
#line 1358 "parser.tab.c"
    break;

  case 28: /* lista_galaxias: lista_galaxias IDENTIFICADOR  */
#line 198 "parser.y"
                                   { (yyval.ruta) = agregar_ruta((yyvsp[-1].ruta), (yyvsp[0].str)); }
